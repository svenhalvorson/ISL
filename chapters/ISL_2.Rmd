...
1. Determine whether a flexible or inflexible method would be preferred in these situations:
...
2. Categorize these situations as regression or classification and identify $n$ and $p$
...
3. Create a rough sketch of a typical plot of square bias, training error rate, testing error rate, and Bayes error rate vs the flexibility of the model. 
...
4. Think of some real life situations to use prediction, inference, and cluster analysis.
    a. Prediction
...
5. Cases in which you might want a less flexible method include:
...
7. Consider using KNN for a point $X_1 = X_2 = X_3 = 0$ using the training set below:
