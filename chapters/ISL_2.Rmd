...
* **Training and testing data**: The initial set of observations used to estimate $f$ is called the training data. Other data called the training set, possibly a subset of your original data set, is used to evaluate the effectiveness of $\hat{f}$,
